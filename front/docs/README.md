...
| [hook-template-feature.md](hook-template-feature.md) | Hook template library | HookTemplate model, toggleable right panel with 4 category tabs (All/Public/Private/Recent), ToggleChip filtering, apply confirmation modal, BookOpenIcon toggle in ScriptMetaHeader, React Query CRUD hooks, Zustand panel store |
