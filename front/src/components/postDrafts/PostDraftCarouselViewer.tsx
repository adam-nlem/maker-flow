        ...
        <div className="rounded-2xl overflow-hidden bg-dark shadow-md mb-4">
            <div className="relative w-full bg-dark flex items-center justify-center min-h-80">
                ...
                <div className="absolute top-3 right-3 px-2 py-0.5 rounded-md bg-dark/60 text-clear text-body-xs">
                    {t("postDrafts:detail.carousel.slideCounter", { current: activeIndex + 1, total: fileCount })}
                </div>
                ...
                <button
                    ...
                    disabled={isFirst}
                    aria-label={t("postDrafts:detail.carousel.previousSlide")}
                ...
                <button
                    ...
                    onClick={handleNext}
                    disabled={isLast}
                    aria-label={t("postDrafts:detail.carousel.nextSlide")}
                ...
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-1.5">
                    {slides.map((_, i) => (
                        <button
                            ...
                            aria-label={t("postDrafts:detail.carousel.goToSlide", { index: i + 1 })}
