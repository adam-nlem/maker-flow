...
export default function ScriptCallToActionCard({ callToAction, scriptUuid, dragHandleProps }: ScriptCallToActionCardProps) {
    ...
    return (
        <ScriptPartCard
            ...
            onDelete={() => deleteScriptCallToAction({ callToActionUuid: callToAction.uuid, scriptUuid })}
