...
export default function CreateIntegrationTile({ provider }: CreateIntegrationTileProps) {
    const { iconUrl } = useShowIntegrationProviderIcon(provider);

    return (
        <div className="border bg-clear border-light-gray rounded-lg p-2 flex flex-col gap-3 w-full">
