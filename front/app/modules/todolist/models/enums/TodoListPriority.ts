...
export const todoItemPriorityToFrenchTranslation: Record<TodoListPriority, string> = {
    [TodoListPriority.Low]: "Basse",
    [TodoListPriority.Medium]: "Moyenne",
    [TodoListPriority.High]: "Haute",
}

export const todoItemPriorityToTextClass: Record<TodoListPriority, string> = {
    [TodoListPriority.Low]: "text-yellow-400",
    [TodoListPriority.Medium]: "text-orange-400",
    [TodoListPriority.High]: "text-danger",
}

export const todoItemPriorityToBgClass: Record<TodoListPriority, string> = {
