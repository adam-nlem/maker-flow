...
| [hook-template-feature.md](hook-template-feature.md) | Hook template library | HookTemplate entity (user-scoped, public/private), HookTemplatePlaceholder enum, CRUD endpoints, search, placeholder system, Script integration (ManyToOne hookTemplate) |
| [script-feature.md](script-feature.md) | Script system for content planning | Script entity, ScriptTag (project-scoped), 5 part types (Chapter, VoiceOver, Dialogue, Shot, Text) in separate tables, DialogueSubject, global position ordering, reorder endpoints, ManyToMany tags, OneToOne PostGroup link, ManyToOne HookTemplate |
