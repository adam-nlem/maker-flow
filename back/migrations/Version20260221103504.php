 ...
 */
final class Version20260221103504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE script ADD hook_template_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE script ADD CONSTRAINT FK_1C81873AA39EFAE8 FOREIGN KEY (hook_template_id) REFERENCES hook_template (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE script DROP hook_template_id');
    }
}
