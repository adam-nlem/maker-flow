...
/**
 * Migration for TodoList module tables
 */
final class Version20260113105120 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create todo_list, todo_list_tag and todo_list_task tables';
    }
