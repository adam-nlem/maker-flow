...
final class Version20260113105110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE integration (id INT AUTO_INCREMENT NOT NULL, uuid CHAR(36) NOT NULL, provider VARCHAR(255) NOT NULL, access_token VARCHAR(255) NOT NULL, refresh_token VARCHAR(255) DEFAULT NULL, scope JSON DEFAULT NULL, account_id VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, profile_picture_url LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, expires_at DATETIME DEFAULT NULL, last_synced_at DATETIME NOT NULL, status VARCHAR(255) NOT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_FDE96D9BD17F50A6 (uuid), INDEX IDX_FDE96D9BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
