...
final class Version20260311000006 extends AbstractMigration
{
    ...
    {
        return 'Create Billing tables (subscription, credit_balance, credit_transaction, stripe_webhook_event)';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, uuid CHAR(36) NOT NULL, stripe_subscription_id VARCHAR(255) NOT NULL, plan VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, current_period_start DATETIME NOT NULL, current_period_end DATETIME NOT NULL, cancel_at_period_end TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_A3C664D3D17F50A6 (uuid), UNIQUE INDEX UNIQ_A3C664D3B5DBB761 (stripe_subscription_id), UNIQUE INDEX UNIQ_A3C664D3A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE credit_balance (id INT AUTO_INCREMENT NOT NULL, uuid CHAR(36) NOT NULL, subscription_credits INT NOT NULL, topup_credits INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_967078D1D17F50A6 (uuid), UNIQUE INDEX UNIQ_967078D1A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
