 ...
 */
final class Version20260119113109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE social_analytics_insight (id INT AUTO_INCREMENT NOT NULL, uuid CHAR(36) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, type VARCHAR(255) NOT NULL, value INT NOT NULL, social_analytics_post_id INT DEFAULT NULL, integration_id INT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_B1378FD748A9F20 (social_analytics_post_id), INDEX IDX_B1378FD79E82DDEA (integration_id), INDEX IDX_B1378FD7A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE social_analytics_insight ADD CONSTRAINT FK_B1378FD748A9F20 FOREIGN KEY (social_analytics_post_id) REFERENCES social_analytics_post (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE social_analytics_insight ADD CONSTRAINT FK_B1378FD79E82DDEA FOREIGN KEY (integration_id) REFERENCES integration (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE social_analytics_insight ADD CONSTRAINT FK_B1378FD7A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE social_analytics_insight DROP FOREIGN KEY FK_B1378FD748A9F20');
        $this->addSql('ALTER TABLE social_analytics_insight DROP FOREIGN KEY FK_B1378FD79E82DDEA');
        $this->addSql('ALTER TABLE social_analytics_insight DROP FOREIGN KEY FK_B1378FD7A76ED395');
        ...
        $this->addSql('DROP TABLE social_analytics_insight');
