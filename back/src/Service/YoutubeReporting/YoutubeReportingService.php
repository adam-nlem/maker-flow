...
namespace App\Service\YoutubeReporting;
...
use App\Entity\YoutubeReportingJob;
...
class YoutubeReportingService
{
    public function __construct(
        ...
        private readonly PostInsightBreakdownRepository $breakdownRepository,
     ...
     * @param array<string, Post> $postsByExternalId
    ...
    public function processBasicReportRows(
        ...
        foreach ($rows as $row) {
            ...
            foreach (YoutubePostInsightDTO::getReportingMetricMapping() as $csvColumn => $insightType) {
                ...
                $breakdown = new PostInsightBreakdown();
